//package be.thomasmore.moremagic.domain.mapping;
//
...
//            SharedSessionContractImplementor connection = sharedSessionContractImplementor.getSession();
//            Array array = connection.doReturningWork(connection1 -> connection1.createArrayOf("int", (Integer[])object));
