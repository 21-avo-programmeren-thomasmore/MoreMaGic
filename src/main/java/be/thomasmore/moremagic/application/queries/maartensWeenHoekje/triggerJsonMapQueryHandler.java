...
@Component
public class triggerJsonMapQueryHandler implements Command.Handler<triggerJsonMapQuery, Voidy> {
...
//    }
    ...
    @Override
    public Voidy handle(triggerJsonMapQuery triggerJsonMapQuery) {
